...
images_loc = '/Users/jacoverster/Desktop/Test_scan_data/2017_07_04';
...
for i = 1:nr_of_images
    ...
    R = I(:,:,1);
    B = I(:,:,3);
    cd '/Users/jacoverster/Desktop/Test_scan_data/2017_07_04/camCal'
    imwrite(R, [image_basename,num2str(i),'.jpg']);
    
    cd '/Users/jacoverster/Desktop/Test_scan_data/2017_07_04/projCal'
